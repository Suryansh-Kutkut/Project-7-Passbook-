import pandas as pd # Allow us to load a csv file data and to work with it
import csv
from datetime import datetime # Module built in python to work with date and time
...
class CSV:
    ...
    @classmethod # To have access to the class itself and not its instance (decorator)
